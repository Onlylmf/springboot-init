...
import com.murphy.project.common.constants.ConfigConstant;
import com.murphy.project.common.utils.LoginUserUtil;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.murphy.project.common.utils.SpringContextUtils;
...
*/
@Service
public class ${entity_name}ServiceImpl extends ServiceImpl<${entity_name}Mapper ,${entity_name}S> implements ${entity_name}Service{
	
	
    @Autowired
	private ${entity_name}Mapper ${model_name}Mapper;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  ${model_name}Mapper.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  ${model_name}Mapper.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(${key_type} id) throws Exception {
		...
		return  ${model_name}Mapper.deleteByPrimaryKey(id);
	}
	...
	public int save(${entity_name} record) throws Exception {
		...
		return ${model_name}Mapper.insertSelective(record);
	}
	...
	public List<${entity_name}> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return ${model_name}Mapper.selectByExample(example);
	}
	...
	public PageInfo<${entity_name}> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
		...
		List<${entity_name}> list = ${model_name}Mapper.selectByExample(example);
	...
	public ${entity_name} selectByPrimaryKey(${key_type} id) throws Exception {
		return ${model_name}Mapper.selectByPrimaryKey(id);
	}
	...
	public int updateByCondition(${entity_name} record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return ${model_name}Mapper.updateByExample(record, example);
	}
	...
	public int updateByPrimaryKey(${entity_name} record) throws Exception {
		return ${model_name}Mapper.updateByPrimaryKeySelective(record);
	}
