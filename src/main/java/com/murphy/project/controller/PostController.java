...
import com.murphy.project.annotation.AuthCheck;
...
import com.murphy.project.model.dto.post.PostAddRequest;
import com.murphy.project.model.dto.post.PostQueryRequest;
import com.murphy.project.model.dto.post.PostUpdateRequest;
import com.murphy.project.model.entity.Post;
import com.murphy.project.model.sys.SysUser;
import com.murphy.project.service.PostService;
...
public class PostController {
    ...
    public BaseResponse<Boolean> deletePost(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 仅本人或管理员可删除
        if (!oldPost.getUserId().equals(user.getId()) && !sysUserService.isAdmin(request)) {
